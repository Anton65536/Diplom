...
//
//    [NSLayoutConstraint activateConstraints:@[
//    [self.buttonProperty.leadingAnchor constraintEqualToAnchor:self.cityNameProperty.trailingAnchor
...
-(void)onButtonHelpWithCity:(id)sender{
    ...
    _cityNameProperty.text = (NSString*)myChosenObject;
        if(myChosenObject){
            ...
            UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Cannot help anymore"
